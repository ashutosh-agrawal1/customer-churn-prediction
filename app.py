...
with st.sidebar:
    ...
    st.info(
        """
        This application predicts customer churn based on key features 
        such as tenure, monthly charges, and contract type.

        It uses a Logistic Regression model built using a scikit-learn 
        pipeline for consistent preprocessing and reliable predictions.

        The app not only predicts churn probability but also explains 
        *why* a customer is likely to churn and suggests actionable steps.
        """
    )
# -----------------------------
# App UI
